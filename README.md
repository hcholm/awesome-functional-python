...
- [unpythonic](https://github.com/Technologicat/unpythonic) ★82 - "Supercharge your Python with parts of Lisp and Haskell."
...
- [python-pattern-matching](https://github.com/grantjenks/python-pattern-matching) ★159 - "Python pattern matching like functional languages."
...
- [RxPy](https://github.com/ReactiveX/RxPY) ★4603 - "Reactive Extensions for Python".
...
- [deal](https://github.com/orsinium/deal) ★648 - "Design by contract for Python with many validators support."
- [chainable](https://github.com/olirice/chainable) ★178 - "Method chaining built on generators".
- [ADT](https://github.com/jspahrsummers/adt) ★165 - Algebraic data types for Python
- [sumtypes](https://github.com/radix/sumtypes) ★41 - "Sum Types, aka Tagged Unions, for Python".
...
- [slist](https://github.com/thejaminator/slist) ★10 - "A drop-in replacement for the python mutable list. But with much more methods for typesafe method chaining."
...
- [MakrellPy](https://github.com/hcholm/makrell-py) - "A general-purpose, functional programming language with two-way Python interoperability, metaprogramming support and simplistic syntax."
